...
- Plan task text: "## Task 3: API mapper + payloads + integration spec (apps/api)"
- OpenSpec mapped tasks: tasks.md group 3 (3.1, 3.2, 3.3)
- Stage: implementing
- Task base commit: (set on dispatch)
- Implementation commit: (pending)
- Changed files: (pending)
- RED/GREEN evidence: (pending — TDD required)
