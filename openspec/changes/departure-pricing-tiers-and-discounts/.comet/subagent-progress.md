...
- Plan task text: "## Task 4: Web — reusable `DepartureFormFields` + editor wiring (apps/web)"
- OpenSpec mapped tasks: tasks.md group 4 (4.1, 4.2, 4.3)
- Stage: implementing
- Task base commit: (set on dispatch)
- Implementation commit: (pending)
- Changed files: (pending)
- RED/GREEN evidence: (n/a for UI wiring — verify via typecheck + lint; no unit test defined by plan)
